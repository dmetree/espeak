    ...
    <div className={s.calendar}>
      ...
      <div className={s.wrapper}>
        ...
        {daysInMonth.map((date) => {
          ...
          const specHasFreeTimeslot = freeTimestamps?.some(
            (timestamp) =>
          ...
          const reqsForCurrentDay = myRequests?.filter(
            ({ scheduledUnixtime }) => {
          ...
          const reqsForCurrentDayStatuses = reqsForCurrentDay
          ...
          return (
            <Cell
              ...
              statuses={reqsForCurrentDayStatuses}
