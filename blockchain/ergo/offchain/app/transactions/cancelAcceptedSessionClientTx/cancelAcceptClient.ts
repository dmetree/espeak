...
import { TransactionHelperCancelAcceptClient } from "./cancel-accept-client-transaction-helper";
...
export async function buildCancelAcceptClient(
  sessionBox: Box, // tx input
  //   therapistAddress: ErgoAddress,
  clientAddress: ErgoAddress,
  nanoErgMinerFee: bigint,
  height: number,
  transactionHelper: TransactionHelperCancelAcceptClient
): Promise<string> {
