...
import { TransactionHelperEndSessionPsychBad } from "./end-session-psych-bad-transaction-helper";
...
export async function buildEndPsychBad(
  sessionBox: Box, // tx input
  nanoErgMinerFee: bigint,
  height: number,
  transactionHelper: TransactionHelperEndSessionPsychBad
): Promise<string> {
