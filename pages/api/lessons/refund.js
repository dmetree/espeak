...
export default async function handler(req, res) {
  ...
  try {
    const { teacherAddress, studentAddress, lessonData, lessonPaymentUnit = 'lovelace' } = req.body;
    if (!lessonData || !lessonData.txId)
      throw new Error("Lesson data with valid txId is required");
    if (!teacherAddress || !studentAddress)
      throw new Error("Both teacherAddress and studentAddress are required");
    ...
    console.log("Validator address:", requestValidatorAddress);
